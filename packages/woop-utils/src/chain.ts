...
const woop = new Unit('1').asWoop();
const woopToGwei = woop.toGwei();
console.log(woopToGwei);
...
const expected = fromWei(Wei, Units.woop);
console.log(expected);

// toWei
const woop = new BN('1');
const expected = toWei(woop, wiki.utils.Units.woop);
